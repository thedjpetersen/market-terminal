...
use crate::features::{
    ...
    watchlist::{
        MonitorColumn, SortDirection, SortField, SortSpec, WatchlistCatalog, WatchlistDefinition,
        WatchlistItem,
    },
};
...
impl DemoMarketDataReplay {
    ...
    fn cursor(&self) -> usize {
        *self.cursor.lock().expect("replay cursor poisoned")
    }
}
    ...
    fn snapshot(self, as_of: &str, sequence: u64) -> QuoteSnapshot {
        ...
        QuoteSnapshot {
            ...
            change: self
                .change
                .zip(self.percent)
                .map(|(absolute, percent)| PriceChange {
...
const FRAME_0: [ReplayQuote; 10] = [
    ...
    replay_quote(
        ...
        184.96,
        188_450_000,
        DataQuality::Delayed { minutes: 15 },
    ),
    replay_quote(
        "us:xnas:meta",
        "META",
        ...
        738.28,
        14_880_000,
        DataQuality::Stale { age_seconds: 180 },
    ),
    replay_quote(
        "us:arcx:spy",
        "SPY",
    ...
    replay_quote(
        ...
        78.43,
        312_400,
        DataQuality::Stale { age_seconds: 42 },
    ),
    ReplayQuote {
        id: "commodity:xau",
        symbol: "XAU",
        ...
        ask: None,
        volume: None,
        quality: DataQuality::PermissionDenied,
    },
];
...
const FRAME_1: [ReplayQuote; 10] = [
    ...
    replay_quote(
        ...
        738.28,
        14_880_000,
        DataQuality::Stale { age_seconds: 181 },
    ),
    replay_quote(
        "us:arcx:spy",
        "SPY",
    ...
    replay_quote(
        ...
        78.45,
        313_100,
        DataQuality::Stale { age_seconds: 43 },
    ),
    ReplayQuote {
        id: "commodity:xau",
        symbol: "XAU",
...
mod tests {
    ...
    fn quote_batches_preserve_canonical_request_order_and_missing_state() {
        ...
        assert_eq!(
            quotes
                ...
                .collect::<Vec<_>>(),
            vec!["fx:eurusd", "unknown:test", "us:xnas:aapl"]
        );
    ...
    fn catalog_resolves_names_without_symbol_identity_leaks() {
        let macro_list = DemoWatchlistCatalog
            .load_watchlist(Some("macro"))
            .expect("macro list");
