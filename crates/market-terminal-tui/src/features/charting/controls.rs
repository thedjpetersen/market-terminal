...
impl ChartControl {
    pub(super) fn action_id(self) -> String {
        match self {
            ...
            Self::ZoomIn => "control:zoom-in".to_owned(),
            Self::ZoomOut => "control:zoom-out".to_owned(),
            Self::PanBack => "control:pan-back".to_owned(),
            Self::PanForward => "control:pan-forward".to_owned(),
    ...
    pub(super) fn from_action_id(id: &str) -> Option<Self> {
        ...
        match id {
            ...
            "control:zoom-in" => Some(Self::ZoomIn),
            "control:zoom-out" => Some(Self::ZoomOut),
            "control:pan-back" => Some(Self::PanBack),
            "control:pan-forward" => Some(Self::PanForward),
